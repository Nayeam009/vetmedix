...
const CartPage = () => {
  ...
  if (items.length === 0) {
    return (
      <div className="min-h-screen bg-muted/30 pb-20 md:pb-0">
        <Navbar />
        <main className="container mx-auto px-4 py-12 sm:py-16 lg:py-24" role="main" aria-label="Empty shopping cart">
  ...
  return (
    <div className="min-h-screen bg-muted/30 pb-32 md:pb-8">
      ...
      <main className="container mx-auto px-4 py-4 sm:py-6 lg:py-8" role="main" aria-label="Shopping cart">
        {/* Header */}
